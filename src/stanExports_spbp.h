...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(124, 123, "end", "/include/loglikbp.stan");
    reader.add_event(124, 2, "restart", "model_spbp");
    reader.add_event(234, 110, "end", "model_spbp");
    return reader;
}
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (as_bool(logical_eq(M, 2))) {
                ...
                stan::math::assign(gamma, multiply(gamma_scaled, stan::math::exp(sum(elt_multiply(beta, means)))));
            } else {
            ...
            if (as_bool(logical_eq(approach, 1))) {
                ...
                if (as_bool(logical_eq(get_base1(priordist, 1, "priordist", 1), 1))) {
                    ...
                    lp_accum__.add(normal_log<propto__>(nu_scaled, get_base1(priorpars, 1, "priorpars", 1), get_base1(priorpars, 2, "priorpars", 1)));
                }
            }
