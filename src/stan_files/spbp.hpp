...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(47, 46, "end", "/chunks/loglikbp.stan");
    reader.add_event(47, 2, "restart", "model_spbp");
    reader.add_event(96, 49, "end", "model_spbp");
    return reader;
}
...
loglikph(const Eigen::Matrix<T0__, Eigen::Dynamic, 1>& beta,
    ...
    try {
        ...
        Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> h0(num_elements(status));
        ...
        validate_non_negative_index("theta", "num_elements(status)", num_elements(status));
        Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> theta(num_elements(status));
        ...
        stan::math::assign(theta, stan::math::exp(multiply(Z, beta)));
...
struct loglikph_functor__ {
    ...
    operator()(const Eigen::Matrix<T0__, Eigen::Dynamic, 1>& beta,
        ...
        return loglikph(beta, gamma, status, Z, b, B, null, pstream__);
    }
};
...
loglikpo(const Eigen::Matrix<T0__, Eigen::Dynamic, 1>& beta,
    ...
    try {
        ...
        Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> r0(num_elements(status));
...
struct loglikpo_functor__ {
    ...
    operator()(const Eigen::Matrix<T0__, Eigen::Dynamic, 1>& beta,
             ...
             const Eigen::Matrix<T5__, Eigen::Dynamic, Eigen::Dynamic>& B,
             const int& null, std::ostream* pstream__) const {
        return loglikpo(beta, gamma, status, Z, b, B, null, pstream__);
    }
};
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (as_bool(logical_eq(M, 0))) {
                ...
                stan::math::assign(loglik, loglikpo(beta, gamma, status, Z, b, B, null, pstream__));
            } else {

                current_statement_begin__ = 84;
                stan::math::assign(loglik, loglikph(beta, gamma, status, Z, b, B, null, pstream__));
            }
