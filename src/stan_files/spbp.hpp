...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(84, 47, "end", "model_spbp");
    return reader;
}
...
loglikph(const Eigen::Matrix<T0__, Eigen::Dynamic,1>& beta,
    ...
    try {
        ...
        validate_non_negative_index("h", "num_elements(status)", num_elements(status));
        Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1>  h(static_cast<Eigen::VectorXd::Index>(num_elements(status)));
        ...
        stan::math::assign(h, multiply(b,gamma));
        current_statement_begin__ = 13;
        stan::math::assign(H, multiply(B,gamma));
        current_statement_begin__ = 14;
        stan::math::assign(eta, multiply(Z,beta));
        current_statement_begin__ = 16;
        stan::math::assign(loglik, subtract(elt_multiply(stan::math::log(elt_multiply(h,stan::math::exp(eta))),status),elt_multiply(H,stan::math::exp(eta))));
...
loglikpo(const Eigen::Matrix<T0__, Eigen::Dynamic,1>& beta,
    ...
    try {
        ...
        validate_non_negative_index("logitF0", "num_elements(status)", num_elements(status));
        Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1>  logitF0(static_cast<Eigen::VectorXd::Index>(num_elements(status)));
        (void) logitF0;  // dummy to suppress unused var warning

        stan::math::initialize(logitF0, DUMMY_VAR__);
        stan::math::fill(logitF0,DUMMY_VAR__);
        current_statement_begin__ = 24;
        validate_non_negative_index("logitF", "num_elements(status)", num_elements(status));
        Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1>  logitF(static_cast<Eigen::VectorXd::Index>(num_elements(status)));
        (void) logitF;  // dummy to suppress unused var warning

        stan::math::initialize(logitF, DUMMY_VAR__);
        stan::math::fill(logitF,DUMMY_VAR__);
        ...
        stan::math::assign(logitF0, multiply(b,gamma));
        current_statement_begin__ = 28;
        stan::math::assign(logitF, multiply(B,gamma));
        current_statement_begin__ = 29;
        stan::math::assign(eta, multiply(Z,beta));
        current_statement_begin__ = 31;
        stan::math::assign(loglik, subtract(elt_multiply(status,add(logitF0,eta)),stan::math::log(add(1,stan::math::exp(logitF)))));
