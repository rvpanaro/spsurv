...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(1, 1, "include", "/chunks/logliks.stan");
    reader.add_event(1, 0, "start", "/chunks/logliks.stan");
    reader.add_event(29, 28, "end", "/chunks/logliks.stan");
    reader.add_event(29, 2, "restart", "model_spbp");
    reader.add_event(71, 42, "end", "model_spbp");
    return reader;
}
...
loglikbp(const Eigen::Matrix<T0__, Eigen::Dynamic,1>& beta,
    ...
    try {
        ...
        validate_non_negative_index("bp", "num_elements(status)", num_elements(status));
        Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1>  bp(static_cast<Eigen::VectorXd::Index>(num_elements(status)));
        ...
        if (as_bool(logical_eq(M,1))) {
            ...
            stan::math::assign(loglik, subtract(elt_multiply(stan::math::log(elt_multiply(bp,stan::math::exp(eta))),status),elt_multiply(BP,stan::math::exp(eta))));
        } else {

            current_statement_begin__ = 22;
            stan::math::assign(loglik, add(elt_multiply(subtract(add(eta,stan::math::log(bp)),stan::math::log(add(stan::math::exp(eta),BP))),status),stan::math::log(add(1,elt_multiply(stan::math::exp(eta),BP)))));
        }
...
struct loglikbp_functor__ {
    ...
    operator()(const Eigen::Matrix<T0__, Eigen::Dynamic,1>& beta,
        ...
        return loglikbp(beta, gamma, status, Z, b, B, M, pstream__);
    }
};
...
public:
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            stan::math::assign(loglik, loglikbp(beta,gamma,status,Z,b,B,M, pstream__));
