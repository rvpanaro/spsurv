...
namespace model_bpph_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_bpph");
    reader.add_event(1, 1, "include", "/chunks/loglikbp.stan");
    reader.add_event(1, 0, "start", "/chunks/loglikbp.stan");
    reader.add_event(20, 19, "end", "/chunks/loglikbp.stan");
    reader.add_event(20, 2, "restart", "model_bpph");
    reader.add_event(61, 41, "end", "model_bpph");
    return reader;
}
...
loglikbp(const Eigen::Matrix<T0__, Eigen::Dynamic,1>& beta,
...
struct loglikbp_functor__ {
    ...
    operator()(const Eigen::Matrix<T0__, Eigen::Dynamic,1>& beta,
        ...
        return loglikbp(beta, gamma, status, Z, b, B, pstream__);
    }
};

#include <meta_header.hpp>
 class model_bpph : public prob_grad {
private:
    int n;
    int m;
    int q;
    ...
    double S_beta;
public:
    model_bpph(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_bpph_namespace::model_bpph";
        ...
        try {
            ...
            context__.validate_dims("data initialization", "m_beta", "double", context__.to_vec());
            m_beta = double(0);
            vals_r__ = context__.vals_r("m_beta");
            pos__ = 0;
            m_beta = vals_r__[pos__++];
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            stan::math::assign(loglik, loglikbp(beta,gamma,status,Z,b,B, pstream__));
            ...
            if (as_bool(logical_eq(approach,1))) {
                ...
                lp_accum__.add(normal_log<propto__>(beta, m_beta, S_beta));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__,params_i__);
        static const char* function__ = "model_bpph_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_bpph_namespace::model_bpph stan_model;
